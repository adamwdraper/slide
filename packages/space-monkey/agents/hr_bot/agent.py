...
@weave.op()
def initialize_hr-bot_agent(thread_store=None, file_store=None, model_name="gpt-4.1", purpose_prompt=None, bot_user_id=None):
    """
    Initialize and return a hr-bot Agent configured with store instances
...
# No tools specified
    ...
    logger.info("hr-bot agent initialized with tools: []")
