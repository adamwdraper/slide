...
# Role and Context
To be a helpful assistant focused on An example Slack bot for testing.
...
- Always be helpful and test thoroughly
</response_guidelines>
...
# Available tools: ['notion:notion-search', 'slack:send-message']
# Sub-agents: ['helper']
# Bot user ID required: True
# Citations required: True
# Specific guidelines: Always be helpful and test thoroughly 