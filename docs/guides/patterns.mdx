...
research_agent = Agent(
    name="Research",
    model_name="gpt-4",
    purpose="To conduct in-depth research on topics",
    tools=WEB_TOOLS
)
...
writer_agent = Agent(
    name="Writer",
    model_name="gpt-4",
    purpose="To write clear, engaging content",
    tools=FILES_TOOLS
)
...
analyst_agent = Agent(
    name="Analyst",
    model_name="gpt-4",
    purpose="To analyze data and images",
    tools=IMAGE_TOOLS
)
...
coordinator = Agent(
    name="Coordinator",
    model_name="gpt-4",
    purpose="To coordinate tasks by delegating to specialists",
    agents=[research_agent, writer_agent, analyst_agent]
)

# The coordinator can now delegate tasks to specialized agents
thread = Thread()
