...
<CardGroup cols={2}>
  <Card
    ...
    icon="vial"
    href="https://github.com/adamwdraper/slide/blob/main/packages/tyler/examples/500_eval_example.py"
  >
  ...
  <Card
    title="Mock Testing"
    icon="masks-theater"
    href="https://github.com/adamwdraper/slide/blob/main/packages/tyler/examples/501_eval_mock_example.py"
  >
