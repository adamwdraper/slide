...
<CardGroup cols={3}>
  <Card
    ...
    icon="rocket"
    href="https://github.com/adamwdraper/slide/blob/main/packages/tyler/examples/003_docs_quickstart.py"
  >
  ...
  <Card
    title="Introduction"
    icon="book-open"
    href="https://github.com/adamwdraper/slide/blob/main/packages/tyler/examples/001_docs_introduction.py"
  >
    Agent fundamentals
  </Card>
</CardGroup>
