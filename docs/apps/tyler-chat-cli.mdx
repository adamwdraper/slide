---
title: 'Tyler chat CLI'
description: 'Interactive command-line interface for chatting with Tyler agents'
---

The Tyler Chat CLI provides an interactive terminal interface for conversing with your Tyler agents. It offers a clean, distraction-free chat experience with streaming responses, conversation persistence, and easy thread management.

## Installation

Tyler Chat CLI is automatically installed when you install the Tyler package:
...
After installation, the `tyler-chat` command will be available in your terminal.
...
Create a `tyler-chat-config.yaml` file:
